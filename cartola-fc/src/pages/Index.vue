    ...
    <div class="row justify-center q-gutter-sm">
      <div class="col-xs-12 col-md-3">
        <q-tabs v-model="tab" inline-label class="bg-primary text-white shadow-2" >
          <q-tab @click="selecionadoJogadores" name='galeria' glossy color="primary"  icon="sports_soccer" label="Jogadores" />
          <q-tab @click="SelecionadoClube" name='planta' glossy color="primary"  icon="ballot" label="Clube" />
        </q-tabs>
      </div>
    </div>
...
export default {
  ...
  methods: {
    getJogadores(){
      let that = this
      that.$axios.get('https://api.cartolafc.globo.com/atletas/mercado')
      // that.$axios.get('https://pokeapi.co/api/v2/pokemon/ditto')
      .then((response) => {
